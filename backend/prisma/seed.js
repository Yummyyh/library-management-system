...
async function main() {
  ...
  // ================= 2. 创建图书与条形码（方案3核心逻辑） =================
  const bookSeeds = [
    { title: "Clean Code", author: "Robert C. Martin", isbn: "9780132350884", genre: "Technology", description: "Classic guide to writing clean, maintainable code.", language: "English", shelfLocation: "Tech-A1", category: "Software Engineering" },
